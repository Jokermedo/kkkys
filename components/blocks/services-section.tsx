...
import { CreditCard, Zap, Globe, Shield, CheckCircle, Star } from "lucide-react"
...
export function ServicesSection() {
  ...
  const servicesContent = content[locale].services
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              {locale === "ar" ? "خدمات التفعيل المالية" : "Financial Activation Services"}
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              {locale === "ar"
                ? "نقدم خدمات تفعيل شاملة لجميع المحافظ الإلكترونية والخدمات المالية"
                : "We provide comprehensive activation services for all e-wallets and financial services"}
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {servicesContent.map((service, index) => {
            const IconComponent = serviceIcons[service.icon as keyof typeof serviceIcons] || CreditCard
              ...
              >
                <Card className="h-full hover:shadow-xl transition-all duration-300 border-0 shadow-md hover:scale-105 group">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-lg font-bold text-gray-900 dark:text-white">{service.title}</CardTitle>
                  </CardHeader>
                  ...
                  <CardContent className="pt-0">
                    <div className="space-y-4">
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{service.price}</div>
