      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center space-x-2 rtl:space-x-reverse group">
            <Shield className="h-8 w-8 lg:h-10 lg:w-10 text-primary group-hover:text-primary/80 transition-colors" />
          ...
          <div className="flex items-center space-x-3 rtl:space-x-reverse lg:space-x-4">
            <Button
              ...
              className="hidden sm:flex items-center space-x-1 rtl:space-x-reverse hover:bg-primary/10"
            >
            ...
            <Button
              asChild
              className="hidden sm:inline-flex bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-primary-foreground shadow-md hover:shadow-lg transition-all duration-200"
            >
              <Link
            ...
            <nav className="flex flex-col space-y-1 p-4 pb-6">
              {navigation.map((item, index) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className="text-base font-medium text-muted-foreground hover:text-foreground hover:bg-primary/10 transition-all duration-200 px-3 py-3 rounded-lg"
                  onClick={(e) => {
                    e.preventDefault()
                    handleNavClick(item.href)
                  }}
              ...
              <div className="flex flex-col space-y-3 pt-6 border-t border-border/50">
                <div className="flex items-center justify-between">
                  <Button
                    ...
                    size="sm"
                    onClick={toggleLanguage}
                    className="flex items-center space-x-2 rtl:space-x-reverse hover:bg-primary/10"
                  >
                    <Globe className="h-4 w-4" />
